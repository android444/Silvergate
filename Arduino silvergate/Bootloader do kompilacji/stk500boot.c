...
#include	"command.h"
	...
	|| defined(__AVR_ATmega2561__) || defined(__AVR_ATmega1284P__) || defined(__AVR_ATmega644__) || defined(ENABLE_MONITOR)
...
#if defined(__AVR_ATmega1284P__) || defined(__AVR_ATmega644__)
#undef BLINK_LED_WHILE_WAITING
 ...
 */
	...
	#define SIGNATURE_BYTES  0x1e9704
